                                ...
                                <div className="bg-base-200/50 rounded-lg p-5 md:p-6 mb-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="flex flex-col gap-2 w-full">
                                            ...
                                            <input type="text" value={data.name} onChange={(e) => setData('name', e.target.value)} placeholder="Nama Lengkap" className="input input-bordered w-full bg-base-100" required />
                                        ...
                                        <div className="flex flex-col gap-2 w-full">
                                            ...
                                            <input type="email" value={data.email} onChange={(e) => setData('email', e.target.value)} placeholder="email@domain.com" className="input input-bordered w-full bg-base-100" required />
                                        ...
                                        <div className="flex flex-col gap-2 w-full">
                                            ...
                                            <input type="text" value={data.phone} onChange={(e) => setData('phone', e.target.value)} placeholder="08..." className="input input-bordered w-full bg-base-100" required />
                                        ...
                                        <div className="flex flex-col gap-2 w-full">
                                            ...
                                            <input type="number" value={data.usia} onChange={(e) => setData('usia', e.target.value)} placeholder="Contoh: 25" className="input input-bordered w-full bg-base-100" required />
                                        ...
                                        <div className="flex flex-col gap-2 w-full md:col-span-2">
                                            ...
                                            <input type="text" value={data.pekerjaan} onChange={(e) => setData('pekerjaan', e.target.value)} placeholder="Pekerjaan" className="input input-bordered w-full bg-base-100" required />
                            ...
                            <div className="card-body p-6">
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex justify-between font-medium">
                                        <span className="text-base-content/70">Harga Tiket ({data.quantity}x)</span>
                                    ...
                                    {!isFree && (
                                        <div className="flex justify-between text-sm">
                                            <span className="text-base-content/60">Biaya Layanan</span>
                                            <span className="font-medium text-base-content/80">{formatPrice(adminFee)}</span>
                                        </div>
                                    )}
                                ...
                                <div className="text-center mt-6">
                                    <Link href={route('events.guest.detail', { event: event.id, slug: event.slug })} className="text-sm font-medium text-base-content/60 hover:text-primary transition-colors flex items-center justify-center gap-2">
