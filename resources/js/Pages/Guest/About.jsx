            ...
            <div className="bg-base-100 py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        <h2 className="text-3xl font-bold tracking-tight text-base-content sm:text-4xl">Tentang Kami</h2>
                    ...
                    <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        <div>
                            <h3 className="border-l border-indigo-600 pl-6 font-semibold text-base-content">Visi Kami</h3>
                            <div className="mt-2 pl-6 text-base-content/70">
                        ...
                        <div>
                            <h3 className="border-l border-indigo-600 pl-6 font-semibold text-base-content">Misi Kami</h3>
                            <div className="mt-2 pl-6 text-base-content/70">
                        ...
                        <div>
                            <h3 className="border-l border-indigo-600 pl-6 font-semibold text-base-content">Nilai-nilai Kami</h3>
                            <div className="mt-2 pl-6 text-base-content/70">
                                <ul className="list-disc list-inside">
                                    <li>Inovasi</li>
                                    <li>Integritas</li>
