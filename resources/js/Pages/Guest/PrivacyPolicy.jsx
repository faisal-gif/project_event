            ...
            <div className="bg-base-100 py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        <h2 className="text-3xl font-bold tracking-tight text-base-content sm:text-4xl">Kebijakan Privasi</h2>
                    ...
                    <div className="mx-auto mt-16 max-w-2xl lg:mx-0 lg:max-w-none">
                        <div className="space-y-8">
                            <div>
                                <h3 className="text-xl font-semibold text-base-content">1. Informasi yang Kami Kumpulkan</h3>
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-base-content">2. Bagaimana Kami Menggunakan Informasi Anda</h3>
                                <p className="mt-4 text-base-content/70">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-base-content">3. Berbagi Informasi Anda</h3>
                                <p className="mt-4 text-base-content/70">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-base-content">4. Keamanan Informasi Anda</h3>
                                <p className="mt-4 text-base-content/70">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-base-content">5. Perubahan pada Kebijakan Privasi Ini</h3>
                                <p className="mt-4 text-base-content/70">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-base-content">6. Hubungi Kami</h3>
                                <p className="mt-4 text-base-content/70">
